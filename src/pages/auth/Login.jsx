  ...
  return (
    <main className="grid min-h-screen bg-[#f3f7f6] lg:grid-cols-[1.05fr_.95fr]">
      <section className="hidden bg-[#102a2a] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="flex items-center gap-3"><span className="grid size-11 place-items-center rounded-xl bg-teal-500"><Building2 /></span><div><p className="text-lg font-semibold">CRM</p><p className="text-xs text-white/50">Business Suite</p></div></div>
      ...
      <section className="flex items-center justify-center p-5 sm:p-10">
        <div className="w-full max-w-md">
          <div className="mb-9 flex items-center gap-3 lg:hidden"><span className="grid size-10 place-items-center rounded-xl bg-teal-600 text-white"><Building2 size={21} /></span><span className="font-semibold">CRM Business Suite</span></div>
